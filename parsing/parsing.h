...
int get_color(mlx_texture_t **texture, int side, double raydir_y, double raydir_x,
              int x, int y, double dist_to_wall, double pos_x, double pos_y, 
              int lineHeight, int drawStart, int drawEnd, int did_we_hit_a_door);
void calculate_draw_bounds(int *drawStart, int *drawEnd, int lineHeight);
void clear_img(t_mlx_helper *mlx);
void draw_player(t_mlx_helper *mlx, int player_x, int player_y, int min_x, int min_y);
void draw_map_(t_utils *util, t_mlx_helper *mlx_utils);
void draw_map_row(t_utils *util, t_mlx_helper *mlx_utils, int map_y);
void draw_tile_pixels(t_mlx_helper *mlx_utils, int map_x, int map_y, int color);
...
void calculate_wall_distance(t_mlx_helper *mlx_utils, t_player *player, int side);
...
bool is_door_blocking(t_mlx_helper *mlx,int x, int y, int type);
void calculate_door_position(t_mlx_helper *mlx, int i, float *door_x, float *door_y);
float calculate_distance_to_door(t_mlx_helper *mlx, float door_x, float door_y);
