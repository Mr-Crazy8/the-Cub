...
/*   Updated: 2026/01/08 17:30:22 by anel-men         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_sprite_frames(t_sprite *sprit)
{
	...
	paths[0] = "parsing/1.xpm42";
	paths[1] = "parsing/2.xpm42";
	paths[2] = "parsing/3.xpm42";
	paths[3] = "parsing/4.xpm42";
	paths[4] = "parsing/5.xpm42";
	paths[5] = "parsing/6.xpm42";
	paths[6] = "parsing/7.xpm42";
	paths[7] = "parsing/8.xpm42";
	i = 0;
	while (i < FIRE_FRAMES)
	{
