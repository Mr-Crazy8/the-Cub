...
int	load_sprite_frames(t_sprite *sprit)
{
	...
	paths[0] = "bonus/1.xpm42";
	paths[1] = "bonus/2.xpm42";
	paths[2] = "bonus/3.xpm42";
	paths[3] = "bonus/4.xpm42";
	paths[4] = "bonus/5.xpm42";
	paths[5] = "bonus/6.xpm42";
	paths[6] = "bonus/7.xpm42";
	paths[7] = "bonus/8.xpm42";
	i = 0;
	while (i < FIRE_FRAMES)
	{
